...
export default function Showcase() {
  ...
  return (
    <section ref={ref} style={{
      ...
      <div style={{
        position: 'absolute', inset: 0,
        background: 'linear-gradient(to bottom, rgba(255,255,255,0.88) 0%, rgba(255,255,255,0.1) 35%, rgba(255,255,255,0.1) 65%, rgba(255,255,255,0.88) 100%)',
      }} />
      ...
      <div style={{ position: 'relative', zIndex: 2, textAlign: 'center', padding: '90px 32px' }}>
        ...
        <motion.p
          ...
          style={{ fontSize: '1rem', color: '#4b5563', maxWidth: 560, margin: '0 auto', lineHeight: 1.78 }}
        >
